...
class SimulationEngineMixin:
    ...
    **Temporal Prediction**: By understanding current process activations and
    ...
    def _derive_relationships(self) -> Dict[str, str]:
        """
        🔗 Derive and analyze higher-level relationships between quantities
        
        This method implements advanced relationship inference that goes beyond
        simple correlation to identify causal, temporal, and domain-specific
        relationships between system quantities.
        
        Returns:
            Dict[str, str]: Mapping of relationship names to relationship types
            
        🔬 Relationship Analysis Theory:
        The method employs multiple analytical approaches:
        
        1. **Directional Correlations**: Analyzes current quantity directions
           to identify positive and negative correlations
        2. **Process-Based Causality**: Uses process influence graphs to
           identify causal relationships between quantities  
        3. **Temporal Correlations**: Examines state history to detect
           patterns of co-variation over time
        4. **Domain Knowledge**: Applies domain-specific patterns to
           identify known physical relationships
    ...
    def _analyze_directional_correlations(self, qty_names: List[str]) -> Dict[str, str]:
        ...
        Returns:
            Dict[str, str]: Directional correlation relationships
        """
    ...
    def _analyze_causal_relationships(self, qty_names: List[str]) -> Dict[str, str]:
        ...
        Returns:
            Dict[str, str]: Process-based causal relationships
        """
    ...
    def _analyze_temporal_correlations(self, qty_names: List[str]) -> Dict[str, str]:
        ...
        Returns:
            Dict[str, str]: Temporal correlation relationships
        """
    ...
    def _compute_temporal_correlation(self, hist1: List['QualitativeDirection'], 
        ...
        Args:
            hist1: Direction history for first quantity
            hist2: Direction history for second quantity
    ...
    def _infer_domain_relationships(self, qty_names: List[str]) -> Dict[str, str]:
        ...
        Returns:
            Dict[str, str]: Domain-specific relationships
        """
        
        domain_rels = {}
        
        # Define common physical domain patterns
        domain_patterns = {
            # Thermodynamics
        ...
        for (concept1, concept2), relationship_type in domain_patterns.items():
